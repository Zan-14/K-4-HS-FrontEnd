const ProfilePage = () => {
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500&family=Montserrat:wght@400;500;600;700;800&display=swap"
    rel="stylesheet"
  />
  {/* container */}
  <div className="bg-neutral-200">
    ...
    {/* main */}
    <section className="flex min-h-screen px-20 py-11 gap-2.5 font-inter">
      {/* left section */}
      <div className="min-w-[20.55vw] h-fit bg-white rounded-xl">
        <a href="profileLihat.html">
          <div className="flex p-5 items-center rounded-t-xl">
            <div>
              <img
                className="w-16 h-16 p-1 border border-grayborder rounded-full "
                src="img/fotoProfilPerusahaan.png"
        ...
        <a href="profileCompany.html">
          <div className="p-5 bg-graybg border-l-4 border-bluetext text-graytext text-sm">
            <h3>Company Size</h3>
          </div>
        </a>
        <a href="profileIndustry.html">
          <div className="p-5 text-graytext text-sm hover:bg-graybg">
            <h3>Industry</h3>
          </div>
        </a>
        <a href="profileLocation.html">
          <div className="p-5 text-graytext text-sm hover:bg-graybg">
            <h3>Specific Location</h3>
          </div>
        </a>
        <a href="profileVacancy.html">
          <div className="p-5 text-graytext text-sm hover:bg-graybg">
            <h3>Vacancy</h3>
          </div>
        </a>
      ...
      {/* right section */}
      <div className="h-fit min-h-[606px] w-full bg-white rounded-xl px-5">
        <div className="flex py-5 items-center">
          ...
          <div className="px-2">
            ...
            <p className="text-xs text-graytext my-2.5">
              (+62) 81234567890 | kelompokempat@gmail.com | <br /> Jakarta
              Timur, DKI Jakarta
            </p>
          </div>
        </div>
